...
extension UIColor {
    public static var ns_red = UIColor(ub_hexString: "#c30045")!
    public static var ns_text = UIColor(ub_hexString: "#4a4969")!.withHighContrastColor(color: .black)

    public static var ns_blue = UIColor(ub_hexString: "#3597d8")!.withHighContrastColor(color: UIColor(ub_hexString: "#59738A")!)
    public static var ns_lightBlue = UIColor(ub_hexString: "#00a7d4")!.withHighContrastColor(color: UIColor(ub_hexString: "#59738A")!)
    public static var ns_blueBackground = UIColor(ub_hexString: "#d6eaf7")!
    public static var ns_green = UIColor(ub_hexString: "#32814b")!.withHighContrastColor(color: UIColor(ub_hexString: "#047E74")!)
    public static var ns_greenBackground = UIColor(ub_hexString: "#ccdfd2")!
